        ...
        <PolicyLayout
            ...
            sections={[
                {
                    content: (
                        <p>
                            At EARTHMINT, we strive to provide exceptional products and customer service. Your satisfaction is our top priority, and we offer the following Return and Refund policy for your peace of mind:
                        </p>
                    ),
                },
                {
                    content: (
                        <p>
                            Eligibility: Our refund policy applies to select products that are eligible for our 100% buyback program. These products include [Gold Coins, Gold Frames & Gold Rakhi].                        </p>
                    ),
                },
                {
                    content: (
                ...
                },
            {
            ...
            },
                {
                    content: (
                        <p>
                            We offer a 100% buyback guarantee on the gold value of our Rakhi.
                        </p>
                    ),
                },
                {
                ...
                },
            {
                content: (
                <p>
                    To initiate the process, please email us and courier the product to our address. Once we receive and inspect the Rakhi, we will process the payment.
                </p>
                ),
            },
                {
